...
window.QRVLang = (function () {
  ...
  const DICTIONARIES = {
    ...
    English: {
      ...
      voiceOnBtn: "Voice ON",
      voiceOffBtn: "Mute All",
      resultDisclaimer: "QRaksha detects patterns — no tool guarantees 100% certainty. When in doubt, verify through official channels.",
      grievanceLabel: "Grievance Officer",
      grievanceContact: "Report an issue: qrakshasupport@gmail.com · Response within 72 hours",
    ...
    Hindi: {
      ...
      voiceOnBtn: "आवाज़ चालू",
      voiceOffBtn: "सब बंद",
      resultDisclaimer: "QRaksha पैटर्न पहचानता है — कोई भी टूल 100% निश्चितता की गारंटी नहीं देता। संदेह होने पर आधिकारिक माध्यम से सत्यापित करें।",
      grievanceLabel: "शिकायत अधिकारी",
      grievanceContact: "समस्या रिपोर्ट करें: qrakshasupport@gmail.com · 72 घंटे में जवाब",
    ...
    Bengali: {
      ...
      voiceOnBtn: "ভয়েস চালু",
      voiceOffBtn: "সব বন্ধ",
      resultDisclaimer: "QRaksha প্যাটার্ন শনাক্ত করে — কোনো টুল ১০০% নিশ্চয়তা দেয় না। সন্দেহ হলে সরকারি মাধ্যমে যাচাই করুন।",
      grievanceLabel: "অভিযোগ কর্মকর্তা",
      grievanceContact: "সমস্যা জানান: qrakshasupport@gmail.com · ৭২ ঘণ্টায় উত্তর",
    ...
    Telugu: {
      ...
      voiceOnBtn: "వాయిస్ ఆన్",
      voiceOffBtn: "అన్నీ మ్యూట్",
      resultDisclaimer: "QRaksha నమూనాలు గుర్తిస్తుంది — ఏ సాధనమూ 100% నిర్ధారణ ఇవ్వదు. అనుమానం ఉంటే అధికారిక మాధ్యమం ద్వారా ధృవీకరించండి.",
      grievanceLabel: "ఫిర్యాదు అధికారి",
      grievanceContact: "సమస్య నివేదించండి: qrakshasupport@gmail.com · 72 గంటల్లో స్పందన",
    ...
    Marathi: {
      ...
      voiceOnBtn: "आवाज सुरू",
      voiceOffBtn: "सर्व बंद",
      resultDisclaimer: "QRaksha नमुने ओळखतो — कोणतेही साधन 100% खात्री देत नाही. शंका असल्यास अधिकृत माध्यमातून तपासा.",
      grievanceLabel: "तक्रार अधिकारी",
      grievanceContact: "समस्या कळवा: qrakshasupport@gmail.com · 72 तासांत उत्तर",
    ...
    Tamil: {
      ...
      voiceOnBtn: "குரல் ஆன்",
      voiceOffBtn: "அனைத்தும் அமைதி",
      resultDisclaimer: "QRaksha முறைகளை கண்டறிகிறது — எந்த கருவியும் 100% உறுதி தர முடியாது. சந்தேகமிருந்தால் அதிகாரப்பூர்வ வழிகளில் சரிபார்க்கவும்.",
      grievanceLabel: "புகார் அதிகாரி",
      grievanceContact: "சிக்கல் தெரிவிக்கவும்: qrakshasupport@gmail.com · 72 மணிநேரத்தில் பதில்",
    ...
    Urdu: {
      ...
      voiceOnBtn: "آواز آن",
      voiceOffBtn: "سب خاموش",
      resultDisclaimer: "QRaksha نمونے پہچانتا ہے — کوئی ٹول 100% یقین نہیں دیتا۔ شک ہو تو سرکاری ذریعے سے تصدیق کریں۔",
      grievanceLabel: "شکایت افسر",
      grievanceContact: "مسئلہ رپورٹ کریں: qrakshasupport@gmail.com · 72 گھنٹے میں جواب",
    ...
    Gujarati: {
      ...
      voiceOnBtn: "અવાજ ચાલુ",
      voiceOffBtn: "બધું બંધ",
      resultDisclaimer: "QRaksha પેટર્ન શોધે છે — કોઈ ટૂલ 100% ખાતરી આપતું નથી. શંકા હોય તો સત્તાવાર માધ્યમ દ્વારા ચકાસો.",
      grievanceLabel: "ફરિયાદ અધિકારી",
      grievanceContact: "સમસ્યા જણાવો: qrakshasupport@gmail.com · 72 કલાકમાં જવાબ",
    ...
    Kannada: {
      ...
      voiceOnBtn: "ಧ್ವನಿ ಆನ್",
      voiceOffBtn: "ಎಲ್ಲ ಮ್ಯೂಟ್",
      resultDisclaimer: "QRaksha ಮಾದರಿಗಳನ್ನು ಪತ್ತೆಮಾಡುತ್ತದೆ — ಯಾವ ಸಾಧನವೂ 100% ಖಚಿತತೆ ನೀಡುವುದಿಲ್ಲ. ಅನುಮಾನವಿದ್ದರೆ ಅಧಿಕೃತ ಮಾರ್ಗದ ಮೂಲಕ ಪರಿಶೀಲಿಸಿ.",
      grievanceLabel: "ದೂರು ಅಧಿಕಾರಿ",
      grievanceContact: "ಸಮಸ್ಯೆ ವರದಿ ಮಾಡಿ: qrakshasupport@gmail.com · 72 ಗಂಟೆಯಲ್ಲಿ ಪ್ರತಿಕ್ರಿಯೆ",
